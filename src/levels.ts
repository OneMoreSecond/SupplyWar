...
export const levels: readonly LevelDefinition[] = [
  ...
  },
  {
    ...
    title: "Encircle the unsupported fortress.",
    briefing: "Attacks from several sides make the unsupported siege visible; the red ring marks its force decay.",
    hint: "Attack the Unsupported Fortress from Main Force, North Flank, and South Flank.",
